...
export class HomePage extends RenderPage {
  element = `
    <nav class="h-20 w-full flex relative">
      ...
      <div class="h-16 w-full bg-dark_blue border-0 border-b-3 border-light_cyan"></div>
    </nav>
    ...
    <div class="grid grid-cols-12 p-14 w-full grow max-w-[1400px] mx-auto">
      <div class="col-span-3 h-full">
        ...
        <div class="flex flex-col w-full h-full gap-8 text-2xl text-gray-400 font-medium">
      ...
      <div class="col-span-9 text-white h-full">
        <div class="font-bold text-xl leading-10">
          Filter by:
          <select name="" id="" class="bg-dark_blue appearance-none px-3 ml-4">
            <option value="">asd</option>
          </select>
        </div>

        <div class="grid grid-cols-12 mt-6 gap-6 h-full max-h-[700px] overflow-scroll overflow-x-hidden pr-2">
          <div class="col-span-4 flex flex-col bg-dark_blue">
            <div class="w-full pt-[54%] bg-[url('/spidershot.jpg')] bg-cover bg-center"></div>

            <div class="flex flex-col p-4 gap-4">
              <div class="flex justify-between items-center">
                <div>
                  <h3 class="font-bold text-lg">SPIDER SHOT</h3>
                  <span class="text-light_blue font-medium">MODE: precision</span>
                </div>
            ...
            <button class="w-full h-12 bg-light_cyan font-medium text-xl" id="gridShotPlay">
              PLAY NOW!
            </button>
          </div>
